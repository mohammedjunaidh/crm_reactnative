...
export default function Googleauth() {
    ...
    const [request, response, promptAsync] = Google.useAuthRequest({
        androidClientId: "1053749738053-cf7b1imvvi2d359633evfvfhehiubhva.apps.googleusercontent.com",
        iosClientId: "139581308140-imf4dv4bogf4aj945eosqvnett4mp06e.apps.googleusercontent.com",
        expoClientId: "1053749738053-pp30i9gh6t62v385h40g31908eea3r6c.apps.googleusercontent.com"
    });
    ...
    const getClientId = () => {
        if (Platform.OS === "ios") {
            ...
            return "1053749738053-cf7b1imvvi2d359633evfvfhehiubhva.apps.googleusercontent.com";
        } else {
